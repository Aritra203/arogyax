    ...
    <div className='w-full max-w-6xl m-5 '>
      ...
      <div className='bg-white border rounded text-sm max-h-[80vh] overflow-y-scroll'>
        ...
        {appointments && Array.isArray(appointments) && appointments.map((item, index) => (
          <div key={index} className='flex flex-wrap justify-between max-sm:gap-5 max-sm:text-base sm:grid grid-cols-[0.5fr_2fr_1fr_1fr_2.5fr_1fr_1fr] gap-1 items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-50'>
