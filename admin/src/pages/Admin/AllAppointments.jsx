        ...
        {appointments.map((item, index) => (
          <div key={index} className='flex flex-wrap justify-between max-sm:gap-2 sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-50'>
            ...
            <div className='flex items-center gap-2'>
              <img 
                src={item.userData.image && item.userData.image.length > 20 ? item.userData.image : assets.upload_area} 
            ...
            <div className='flex items-center gap-2'>
              <img 
                src={item.docData.image && item.docData.image.length > 20 ? item.docData.image : assets.upload_area} 
